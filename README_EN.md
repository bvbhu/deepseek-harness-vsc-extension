...
>
> **Tested dsh version: `0.1.7-rc.1`** (since extension `0.1.17`).
>
> Since `0.1.17` the extension speaks Session log V4 (dsh `0.1.7`): logs and events from older versions (`0.1.2` – `0.1.6`) still replay correctly.
